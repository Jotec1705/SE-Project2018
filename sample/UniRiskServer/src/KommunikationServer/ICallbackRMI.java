...
public interface ICallbackRMI extends Remote {
     ...
     * @return True
     */
    boolean spielBeendet() throws RemoteException;
     ...
     */
    boolean zugZuteilung(String nameSpieler) throws RemoteException;
     ...
     * @return ob Aktion erfolgreich
     */
    boolean angriffAbwehren(String nameSpieler, Integer verteidigerGeb) throws RemoteException;
     ...
     * @return ob Aktion erfolgreich.
     */
    boolean aktualisierenKarte() throws RemoteException;
     ...
     * @return ob Aktion erfolgreich.
     */
    boolean aktualisierenLobby() throws RemoteException;
    ...
    boolean wuerfelErgebnis(String nameSpieler, int[] wuerfelVerteidiger, int[] wuerfelAngreifer,
                            Integer verloreneErsties, Integer gewonnen) throws RemoteException;
